...
2. **Visualizar Dados da API**: em formato JSON, Clique [https://toy-control-system.onrender.com/api/brinquedos](https://toy-control-system.onrender.com/api/brinquedos).
