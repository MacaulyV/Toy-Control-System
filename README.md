...
2. **Visualizar Dados da API**: Para verificar os dados em formato JSON, Clique [https://toy-control-system.onrender.com/api/brinquedos](https://toy-control-system.onrender.com/api/brinquedos).
